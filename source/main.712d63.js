...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global) {
	    ...
	    var iDisqus = function iDisqus() {
	        var _ = this;

	        // 配置
	        _.opts = (0, _typeof3.default)(arguments[1]) == 'object' ? arguments[1] : arguments[0];
	    ...
	    iDisqus.prototype.timeAgo = function () {
	        ...
	        for (var i in elements) {
	            var $this = elements[i];
	            if ((typeof $this === 'undefined' ? 'undefined' : (0, _typeof3.default)($this)) === 'object') {
	    ...
	    iDisqus.prototype.count = function () {
	        ...
	        if (qty > 0) {
	            ...
	            getAjax(_.opts.api + '/count.php?links=' + commentArr.join(','), function (resp) {
	                var data = JSON.parse(resp);
	    ...
	    iDisqus.prototype.popular = function () {
	        var _ = this;
	        if (!!_.opts.popular) {
	            getAjax(_.opts.api + '/popular.php', function (resp) {
	                var data = JSON.parse(resp);
	                if (data.code == 0) {
	                    var posts = data.response;
	                    var postsHtml = '';
	    ...
	    iDisqus.prototype.getlist = function () {
	        ...
	        _.dom.querySelector('#idisqus').style.display = 'block';
	        _.dom.querySelector('#disqus_thread').style.display = 'none';
	        getAjax(_.opts.api + '/getcomments.php?ident=' + _.opts.identifier + '&link=' + _.opts.url + (!!_.stat.next ? '&cursor=' + _.stat.next : ''), function (resp) {
	            var data = JSON.parse(resp);
	            if (data.code === 0) {
	    ...
	    iDisqus.prototype.load = function (post) {
	        ...
	        if (!!post.username && _.stat.users.map(function (user) {
	    ...
	    iDisqus.prototype.verify = function (e) {
	        ...
	        getAjax(_.opts.api + '/getgravatar.php?email=' + $email.value + '&name=' + $name.value, function (resp) {
	            var data = JSON.parse(resp);
	    ...
	    iDisqus.prototype.post = function (e) {
	        ...
	        if (!item.dataset.currentId) {
	            ...
	            var alertClear = function alertClear() {
	                setTimeout(function () {
	                    alertmsg.innerHTML = '';
	                }, 3000);
	            };
	        ...
	        if (!!mentions) {
	            mentions = mentions.filter(function (mention) {
	                return _.stat.users.map(function (user) {
	                    return user.username;
	    ...
	    /* CommonJS */
	    if ("function" === 'function' && ( false ? 'undefined' : (0, _typeof3.default)(module)) === 'object' && module && ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && exports) module.exports = iDisqus;
	    /* AMD */
	    else if ("function" === 'function' && __webpack_require__(88)['amd']) !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	            return iDisqus;
	        }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	        /* Global */
	        else global['iDisqus'] = global['iDisqus'] || iDisqus;
	})(window || undefined);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _photoswipe = __webpack_require__(90);

	var _photoswipe2 = _interopRequireDefault(_photoswipe);

	var _photoswipeUiDefault = __webpack_require__(91);
